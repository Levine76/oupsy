...
class TrainRNN_AE:
    ...
    def train_test(self, testPart=0.1,data_dir='',type=None,save_dir=''):   
        ...
        for epoch in range(0,self.epoch):
            ...
            for i in range(len(x_trains)):
                ...
                #for batch_idx, (idex, x, y) in enumerate(trainloader):
                    ...
                    print('test indentation: {}'.format(y)) #l'indentation test ne s'affiche pas
        ...
        print("slt")
            ...
            #torch.save(model.state_dict(), save_dir+'\RNN-GRU-layer_'+'epode_' + str(epoch)+ '_BCEFL'+ '.pt')
            #+ typeo
      #  torch.save(model.state_dict(), save_dir + '\RNN-GRU-layer_' + 'epode_' + '4'+ '.pt')
...
if __name__=='__main__':
    ...
    model_path = config.pathToLongdress2RNNModel
    rnn_train_dir = config.pathToLongdress2RNNTrain
    ...
    train = TrainRNN_AE(rnn_model,device,batch_size=1,learning_rate=0.01,epoch=5,loss_func='MSE')
